...
const profileName = "_jaccon_";
const scrappingUrl = "https://instagram.com/";

class webScrapping {

    constructor(path = profileName, host = scrappingUrl) {
        this.path = path
        this.host = host
    ...
    buildJSON() {
        ...
        fs.writeFileSync('instagram-images.json', JSON.stringify(tmp, null, 2));
    }
}
